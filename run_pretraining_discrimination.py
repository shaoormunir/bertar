...
class SaveMetricsHook(tf.train.SessionRunHook):
  ...
  def after_run(self, run_context, run_values):
    ...
    df = df.append({"total_loss":self.total_loss.eval(), "synthetic_prediction_loss":self.synthetic_prediction_loss.eval(),"next_sentence_loss":self.next_sentence_loss.eval(),"masked_lm_loss":self.masked_lm_loss.eval()}, ignore_index=True)
...
# TODO: Look at this for the classification model example
