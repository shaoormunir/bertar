...
class SaveMetricsHook(tf.train.SessionRunHook):
  ...
  def after_run(self, run_context, run_values):
    ...
    df = df.append({"total_loss":self.total_loss, "synthetic_prediction_loss":self.synthetic_prediction_loss,"next_sentence_loss":self.next_sentence_loss,"masked_lm_loss":self.masked_lm_loss}, ignore_index=True)
