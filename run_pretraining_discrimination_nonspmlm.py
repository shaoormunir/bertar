...
flags.DEFINE_string(
    "output_dir", "gs://bert-checkpoints-test/bertar-nonspmlm/base-model-run-1",
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      def metric_fn(synthetic_example_loss, synthetic_log_probs, synthetic_labels):
      ...
      eval_metrics = (metric_fn, [next_sentence_labels, synthetic_example_loss, synthetic_log_probs, synthetic_labels
      ])
      output_spec = tf.contrib.tpu.TPUEstimatorSpec(
          mode=mode,
          loss=total_loss,
