...
flags.DEFINE_string("task_name", "bertar", "The name of the task to train.")
...
class BERTARProcessor(DataProcessor):
  """Processor for discrimination."""
